...
class GoodsCategory(models.Model):
    ...
    parent_category = models.ForeignKey("self",null=True,blank=True,verbose_name="父类类别",on_delete=models.CASCADE,help_text="父类类别",related_name="sub_cat")
...
class GoodsCategoryBrand(models.Model):
    ...
    dec  = models.CharField(default="",max_length=200,verbose_name="品牌描述",help_text="品牌描述")
    image = models.ImageField(max_length=200,upload_to="brands/",verbose_name="照片")
    add_time  = models.DateTimeField(default=datetime.now,verbose_name="添加时间")
...
class Goods(models.Model):
    ...
    market_price = models.IntegerField(default=0,verbose_name="商品价格")
