    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('category_type', models.IntegerField(choices=[(1, '一级类目'), (2, '二级类目'), (3, '3级类目')], help_text='类目级别', verbose_name='类目级别')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dec', models.CharField(default='', help_text='品牌描述', max_length=200, verbose_name='品牌描述')),
                ('image', models.ImageField(max_length=200, upload_to='brand/images/', verbose_name='照片')),
                ('add_time', models.DateTimeField(default=datetime.datetime.now, verbose_name='添加时间')),
            ],
            options={
                'verbose_name': '品牌',
